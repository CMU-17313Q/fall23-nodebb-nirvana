        ...
        <div class="topic-header">
            <h1 component="post/header" class="" itemprop="name">
                <span class="topic-title">
                    ...
                    <span class="icon-{postType}" style="font-size: 16px; background-color: #f4f4f4; padding: 5px 10px; border-radius: 5px; color: #333; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.1); display: inline-block;">Anonymous Post</span>
                </span>
            </h1>
